...
function kamal_custom_product_card_css_js() {
    ...
    <style>
        ...
        /* দুটি বাটনের মাঝখানের দূরত্ব (Gap) আরও বাড়ানো হলো */
        .custom-btn-details { 
            background-color: #ffffff !important; 
            color: #222222 !important; 
            margin-bottom: 22px !important; /* গ্যাপ বাড়িয়ে ২২ পিক্সেল করা হলো */
        ...
        @media only screen and (max-width: 768px) {
            ...
            .custom-image-hover-container { 
                height: 300px !important; /* মোবাইলের জন্য ইমেজ হাইট বাড়িয়ে ৩০০ পিক্সেল করা হলো */
            }
            .custom-hover-buttons-overlay a {
                width: 80% !important; 
            ...
            .custom-btn-details {
                margin-bottom: 18px !important; /* মোবাইলের জন্যও গ্যাপ বাড়িয়ে দেওয়া হলো */
            }
        }
    </style>
