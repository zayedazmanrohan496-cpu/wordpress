...
function kamal_custom_product_card_css_js() {
    ...
    <style>
        ...
        .custom-product-card-box { 
            ...
            /* কার্ডের মূল প্যাডিং ০ করা হয়েছে যাতে ইমেজ পুরো জায়গা জুড়ে থাকে */
            padding: 0 !important; 
        ...
        /* ডেস্কটপের জন্য ইমেজ কন্টেইনার হাইট (পূর্বে 270px ছিল, বাড়িয়ে 340px করা হয়েছে) */
        .custom-image-hover-container { position: relative; overflow: hidden; width: 100%; height: 340px; display: block; margin-bottom: 0 !important; }
        ...
        /* টেক্সট ও অন্যান্য এলিমেন্টের জন্য আলাদা সাইড প্যাডিং */
        ...
        .custom-product-price { padding: 0 10px !important; }
        ...
        .custom-star-rating { color: #ffc107 !important; font-size: 14px !important; margin-top: 2px !important; margin-bottom: 12px !important; padding: 0 10px !important; }
        ...
        @media only screen and (max-width: 768px) {
            ...
            .custom-image-hover-container { 
                /* মোবাইলের জন্য ইমেজ কন্টেইনার হাইট (পূর্বে 140px ছিল, বাড়িয়ে 210px করা হয়েছে) */
                height: 210px !important; 
            }
            .custom-hover-buttons-overlay a {
                width: 80% !important; 
                /* মোবাইলে বাটনগুলোর হাইট ও প্যাডিং একটু বাড়িয়ে দেওয়া হলো */
