<?php
/**
 * WooCommerce Custom Horizontal Product Card Layout (Single File Integration)
 * Terracotta Color Scheme Applied (#e07a5f / #d06245)
 */

// ১. WooCommerce default "Added to cart" নোটিশ বন্ধ করা
add_filter( 'wc_add_to_cart_message_html', '__return_false' );

// ২. Right Side Wrapper Start
...
function custom_wc_add_buy_now_button() {
    ...
    $checkout_url = 'https://healthandbeautybd.infinityfreeapp.com/checkout/?add-to-cart=' . $product_id;

    echo '<a href="' . esc_url($checkout_url) . '" class="button custom-buy-now-btn">Buy now</a>';
}

// ৫. Wrapper Container Close করা
...
// ৬. CSS Styles & JS Script Head section-এ সংযুক্ত করা
add_action('wp_head', 'custom_wc_card_horizontal_styles_and_scripts');
function custom_wc_card_horizontal_styles_and_scripts() {
    if ( is_admin() ) return;
    ?>
    <!-- Google Fonts -->
    ...
    <style id="custom-wc-card-desktop-adjust-style">
        ...
        @media (max-width: 640px) {
            ...
            /* Responsive Product Image Size (Bigger Height) */
            .woocommerce ul.products li.product img {
