...
function kamal_custom_product_card_css_js() {
    ...
    <style>
        ...
        .custom-product-card-box { 
            ...
            padding: 0 !important; 
            border: none !important; /* বর্ডার রিমুভ করা হয়েছে */
            box-shadow: none !important; /* বক্স শ্যাডো রিমুভ করা হয়েছে */
            overflow: hidden;
        }
        
        /* ডেস্কটপ ও ট্যাবলেটের জন্য ইমেজ কন্টেইনার হাইট */
        ...
        /* ফাঁকা (Outline) স্টার আইকন স্টাইল */
